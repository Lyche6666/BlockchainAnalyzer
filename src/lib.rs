// src/lib.rs
/*
 * Core library for BlockchainAnalyzer
 */
...
#[derive(Debug)]
pub struct BlockchainAnalyzerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl BlockchainAnalyzerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BlockchainAnalyzer processing");
    
    let mut processor = BlockchainAnalyzerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BlockchainAnalyzerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BlockchainAnalyzerProcessor::new(false);
